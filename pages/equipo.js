    ...
    <div className="page">
      ...
      <nav className="nav">
        <Link className="brand" href="/">
          <span className="brand-badge">
            <Image src="/empresa/ethos-ia-logo-v2.png" alt="Ethos IA" width={34} height={34} priority className="brand-mark-img" />
          </span>
        ...
        <div className="perfiles-grid">
          <Reveal className="team-card">
            <div className="team-photo">
              <Image src="/empresa/marlon-profile.jpg" alt="Marlon David Pérez Almachi — Cofundador y Director Técnico" width={180} height={180} className="team-photo-img" />
            </div>
            <div>
              ...
              <div className="social-row">
                <a className="social-btn fb" href="https://www.facebook.com/IngMarlonPerez2026/" target="_blank" rel="noopener noreferrer" aria-label="Facebook de Marlon Pérez">
                ...
                <a className="social-btn li" href="https://www.linkedin.com/in/marlon-p%C3%A9rez-06ab32303/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn de Marlon Pérez">
                ...
                <a className="social-btn x" href="https://x.com/IngMarlonPere" target="_blank" rel="noopener noreferrer" aria-label="X de Marlon Pérez">
                ...
                <a className="social-btn gh" href="https://github.com/ing-MarlonPerez" target="_blank" rel="noopener noreferrer" aria-label="GitHub de Marlon Pérez">
                ...
                <a className="social-btn wa" href={whatsappLink} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp de Ethos IA">
          ...
          <Reveal className="team-card" style={{ transitionDelay: '90ms' }}>
            <div className="team-photo">
              <Image src="/empresa/karen-herrera-avatar.png" alt="Karen Dayanna Herrera Ruiz — Cofundadora" width={180} height={180} className="team-photo-img" />
            </div>
            <div>
              ...
              <div className="social-row">
                <EmailChooser>
                  {(props) => (
                    <a {...props} className="social-btn mail" aria-label="Escribir a Ethos IA">
      ...
      <section className="perfiles areas">
        ...
        <div className="perfiles-grid">
          <Reveal className="team-card">
            <div className="team-photo">
              <Image src="/empresa/liliana-perez-avatar.png" alt="Ing. Liliana Pérez — Jefa de Talento Humano" width={180} height={180} className="team-photo-img" />
            </div>
            <div>
          ...
          <Reveal className="team-card" style={{ transitionDelay: '90ms' }}>
            <div className="team-photo">
              <Image src="/empresa/william-toscano-avatar.jpg" alt="William Alejandro Toscano Pérez — Diseño y creación del logotipo" width={180} height={180} className="team-photo-img" />
            </div>
            <div>
              ...
              <p>
                ...
                <a href="https://www.unemi.edu.ec/index.php/carreras-presencial/multimedia-y-produccion-audiovisual/" target="_blank" rel="noopener noreferrer">
                  Multimedia y Producción Audiovisual
                </a>{' '}
                por la Universidad Estatal de Milagro (UNEMI).
              </p>
              <div className="social-row">
                <a className="social-btn mail" href="mailto:zoomgameplay4@gmail.com" aria-label="Escribir a William Toscano">
                  <svg viewBox="0 0 24 24"><path d="M3 5.5A2.5 2.5 0 0 1 5.5 3h13A2.5 2.5 0 0 1 21 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 18.5v-13Zm2.2.3 6.8 5.1 6.8-5.1H5.2ZM19 7.4l-6.7 5-.6.4-.6-.4L4.4 7.4V18.5c0 .6.4 1 1 1h13c.6 0 1-.4 1-1V7.4Z" /></svg>
                </a>
                <a className="social-btn wa" href="https://wa.me/593998146057" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp de William Toscano">
                  <svg viewBox="0 0 24 24"><path d="M12 2C6.5 2 2 6.5 2 12C2 13.8 2.47 15.5 3.34 17L2 22L7.15 20.68C8.61 21.49 10.27 21.92 12 21.92H12.01C17.51 21.92 22 17.42 22 11.92C22 9.26 20.95 6.76 19.05 4.87C17.15 2.98 14.66 2 12 2ZM12 20.15C10.46 20.15 8.96 19.73 7.65 18.94L7.34 18.75L4.32 19.54L5.12 16.61L4.9 16.28C4.03 14.92 3.57 13.35 3.57 11.72C3.57 7.07 7.35 3.28 12 3.28C14.25 3.28 16.36 4.16 17.94 5.75C19.53 7.34 20.43 9.46 20.43 11.72C20.42 16.38 16.65 20.15 12 20.15ZM16.6 13.85C16.35 13.72 15.11 13.11 14.88 13.02C14.65 12.94 14.48 12.9 14.32 13.16C14.15 13.41 13.67 13.98 13.52 14.15C13.38 14.32 13.23 14.34 12.98 14.21C12.73 14.08 11.92 13.81 10.96 12.95C10.21 12.28 9.7 11.46 9.56 11.2C9.42 10.95 9.55 10.81 9.68 10.68C9.79 10.57 9.93 10.39 10.06 10.25C10.19 10.1 10.23 10 10.31 9.84C10.4 9.67 10.35 9.53 10.29 9.4C10.23 9.28 9.72 8.03 9.5 7.53C9.29 7.03 9.08 7.1 8.92 7.09C8.77 7.08 8.6 7.08 8.44 7.08C8.28 7.08 8.02 7.14 7.79 7.39C7.57 7.64 6.95 8.22 6.95 9.47C6.95 10.72 7.81 11.93 7.94 12.1C8.07 12.27 9.71 14.8 12.23 15.9C13.79 16.58 14.4 16.64 15.18 16.52C15.65 16.45 16.63 15.92 16.85 15.34C17.06 14.76 17.06 14.27 17 14.15C16.94 14.03 16.85 13.98 16.6 13.85Z" /></svg>
                </a>
              </div>
            </div>
      ...
      <style jsx>{`
        ...
        :global(body) { background: #eaf2f8; }
        .page { font-family: var(--font-brand), -apple-system, sans-serif; color: #05111e; background: #eaf2f8; min-height: 100vh; }
        :global(a) { color: #0b5f75; text-decoration: none; }
        :global(a:hover) { color: #04ebff; }
        ...
        .nav { display: flex; align-items: center; justify-content: space-between; padding: 16px 32px; background: #05111e; }
        :global(.brand) { display: flex; align-items: center; gap: 10px; padding: 8px 16px; border: 1px solid #123048; border-radius: 999px; text-decoration: none; }
        .brand-badge { width: 34px; height: 34px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        .brand-badge :global(img) { width: 100%; height: 100%; object-fit: contain; }
        .brand-name { font-family: var(--font-brand), sans-serif; font-size: 15px; font-weight: 600; color: #eaf2f8; }
        :global(.nav-back) { font-size: 13px; color: #c4d3e0; text-decoration: none; }
        :global(.nav-back:hover) { color: #04ebff; }

        .hero { padding: 72px 48px 56px; background: #05111e; color: #eaf2f8; }
        .eyebrow { display: block; font-family: var(--font-brand), sans-serif; font-size: 12px; letter-spacing: 0.18em; color: #04ebff; }
        .hero h1 { font-family: var(--font-brand), sans-serif; font-size: clamp(1.8rem, 3.4vw, 2.6rem); line-height: 1.2; font-weight: 600; margin: 16px 0 0; max-width: 22ch; text-wrap: balance; }
        .hero-sub { font-size: 15px; line-height: 1.7; color: #c4d3e0; margin: 20px 0 0; max-width: 60ch; }

        :global(.section-label) { display: block; text-align: center; font-family: var(--font-brand), sans-serif; font-size: 11px; letter-spacing: 0.18em; color: #526373; margin-bottom: 32px; }

        .origen { padding: 64px 48px; background: #ffffff; display: flex; flex-direction: column; align-items: center; }
        .origen-text { max-width: 640px; text-align: center; font-family: var(--font-brand), sans-serif; font-size: 17px; line-height: 1.7; color: #14202b; margin: 0; }

        .perfiles { padding: 64px 48px 72px; background: #eaf2f8; }
        .perfiles.areas { border-top: 1px solid rgba(5,17,30,0.08); padding-top: 56px; }
        ...
        :global(.team-card) {
          ...
          background: #ffffff; border-radius: 14px; padding: 32px; border: 1px solid rgba(5,17,30,0.08);
          box-shadow: 0 18px 40px rgba(5,17,30,0.06);
        }
        .team-photo {
          width: 150px; height: 150px; border-radius: 50%; overflow: hidden; margin: 0 auto;
          border: 3px solid #04ebff; box-shadow: 0 0 0 6px rgba(4,235,255,0.12);
        }
        .team-photo :global(img) { width: 100%; height: 100%; object-fit: cover; display: block; }
        .perfil-role { font-family: var(--font-brand), sans-serif; font-size: 11px; letter-spacing: 0.08em; font-weight: 700; margin-bottom: 14px; }
        .perfil-role.teal { color: #0b5f75; }
        .perfil-role.gold { color: #0f5876; }
        .perfil-name { font-family: var(--font-brand), sans-serif; font-size: 18px; font-weight: 600; color: #05111e; margin-bottom: 14px; }
        :global(.team-card) p { font-size: 14px; color: #33414d; line-height: 1.7; margin: 0 0 18px; }
        .social-row { display: flex; gap: 10px; flex-wrap: wrap; }
        .social-btn {
          width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center;
          background: #05111e; border: 1px solid rgba(5,17,30,0.1); color: #c4d3e0; transition: all 0.2s ease;
        }
        .social-btn svg { width: 17px; height: 17px; fill: currentColor; }
        .social-btn:hover { border-color: #04ebff; color: #04ebff; transform: translateY(-2px); }
        ...
        .social-btn.mail:hover { color: #2b87ad; }
        ...
        .foot { background: #030a12; color: #93aabb; padding: 32px 48px; display: flex; flex-wrap: wrap; justify-content: space-between; gap: 12px; font-size: 12px; }
